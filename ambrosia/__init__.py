...
class Ambrosia(object):
    ...
    def adjust_times(self):
        ...
        adjusted (to the clock of the analysis machine). See :class:`ambrosia.clocks.ClockSyncer`.

        This method should be called right after the :class:`ambrosia.Ambrosia` class has been created.
    ...
    def correlate(self):
        ...
        This method finds all Correlaters (see :class:`ambrosia.plugins.PluginManager`) and starts them.
    ...
    def serialize(self):
        """Serialize Events into a compact text format (see :func:`ambrosia.util.serialize_obj`).
...
class Correlator(object):
    ...
    The :class:`ambrosia.plugins.PluginInfoTop` specifies a priority for each Correlator. This allows to force a
    ...
    def update_tree(self):
        ...
        If the subclass uses the :func:`ambrosia.model.Event.iter_events` in a loop it may not add or remove events from
...
class ResultParser(object):
    ...
    def start_parsers(el, context):
        """Starts all ResultParsers registered in the :class:`ambrosia.plugins.PluginManager`.
