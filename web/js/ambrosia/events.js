...
SyscallEvent.filters = [new Filter('0==1')];

function StartTaskEvent(){
}
StartTaskEvent.filters = [
    new Filter('is_process==false')
];
StartTaskEvent.prototype = new BlockEvent();
StartTaskEvent.prototype.getColor = function(){ return '#ff008a'; }

function MemoryMapEvent(){
}
MemoryMapEvent.prototype = new BlockEvent();
MemoryMapEvent.prototype.getColor = function(){ return '#eb00ff'; }
MemoryMapEvent.filters = [new Filter('anonymous==false')]

function DeleteFileEvent(){
}
DeleteFileEvent.filters = [
    new Filter('file.abspath != "/data/ananaslkm.ko"')
];
...
FileEvent.filters = [
    ...
    new Filter('!(abspath ~ "/system/framework/.*\\.jar" && mode==131072 && process.type=="ADBD_CHILD")')
];
...
UnknownFdEvent.filters = [new Filter('0==1')];

function SocketEvent(){
}
SocketEvent.filters = [
    new Filter('process.type != "ADBD"')
];
